                    ...
                    <CardBody>
                        <div className="d-flex mb-3">
                            ...
                            <div className="flex-shrink-0">
                                <Link to="#" className="badge badge-soft-warning badge-border me-1">BTC</Link>
                                <Link to="#" className="badge badge-soft-info badge-border me-1">ETH</Link>
                                <Link to="#" className="badge badge-soft-primary badge-border me-1">USD</Link>
